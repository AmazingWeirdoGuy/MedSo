...
- **Members Scrollable List**: Added vertical scroll for Active Members section
  - Shows max 5-6 members at a time with vertical scroll when there are more than 6 active members
  - Smooth scrollbar styling with hover effects
  - Falls back to normal vertical list when 6 or fewer members
- **Bug Fixes**:
